document.addEventListener('DOMContentLoaded', () => {
  ...
  const worksData = {
    'typing-rouge': {
      title: '卒業研究（ゲーム名未定）',
      altText: '卒業研究',
      images: ['img/samples/typing_rouge1.png', 'img/samples/typing_rouge2.png', 'img/samples/typing_rouge3.jpg'],
      videos: [],
      description: `
      <p>卒業研究のために、タイピングゲームとローグライトを掛け合わせた戦闘ゲームの制作しています（卒業研究では UI の認識しやすさに関する研究を行います）。</p>
      <p>6月上旬現在では、「戦闘システム」「エリアのランダム生成」「エリア間移動」といった基本的な処理が出来上がっています。
      このペースで開発を進められれば、今月中にゲームとして遊ぶための最低限の機能は完成する見込みです。</p><br />
      ...
      加えて制作猶予が1年未満と非常に短いため、プログラムの作成には積極的に生成AIを活用しています（コードチェックやバグの修正などは人力で行っています）。</p>
    ...
    'minesweeper': {
      ...
      description: `
        ...
        <p>【2026/06/04追記】Mac 上で動作するようにアップデートを行いました（大半はAIに依頼しました）。</p>
      `,
      period: '3日（2025年8月下旬）',
      dev: 'C++',
      links: [
