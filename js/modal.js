  ...
  const worksData = {
    ...
    'minesweeper': {
      ...
      description: `
        ...
        本家様のように特殊ルールを巧みに使った手筋などはありませんが、ルールが作れただけでも良かったです。</p>
        <p>工夫点として、理不尽なゲームオーバーを避けるために、最初は確定でマスが開けられるように設定しています。
        また、数字や旗に色を付けることで、ターミナル上での見やすさにこだわりました。</p>
        <p>【2026/06/04追記】Mac 対応しました！（対応はAIに依頼しました。）</p>
      `,
      period: '3日（2025年8月下旬）',
      dev: 'C++',
      links: [
    ...
    'survive': {
      ...
      description: `
        ...
        <p>（↑データが大きく破損しており、誰も最終盤のデータを持っていなかったため、修正は断念しました）</p>
      `,
      period: '約2ヶ月',
      dev: 'Unity',
      links: [
